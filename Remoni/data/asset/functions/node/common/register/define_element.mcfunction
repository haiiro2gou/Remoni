#> asset:node/common/register/define_element
...
# 属性取得
    execute store result score $Element.None Temporary run data get storage asset:node Element.None 100.0
    execute store result score $Element.Fire Temporary run data get storage asset:node Element.Fire 100.0
    execute store result score $Element.Water Temporary run data get storage asset:node Element.Water 100.0
    execute store result score $Element.Wind Temporary run data get storage asset:node Element.Wind 100.0
    execute store result score $Element.Earth Temporary run data get storage asset:node Element.Earth 100.0
    execute store result score $Element.Light Temporary run data get storage asset:node Element.Light 100.0
    execute store result score $Element.Dark Temporary run data get storage asset:node Element.Dark 100.0

# 形質決定
    execute store result score $Amount.Base Temporary run data get storage asset:node Amount 10.0
...
# None
    ...
    execute store result storage asset:node Amount.None double 0.001 run scoreboard players get $Amount.None Temporary
...
# Fire
    ...
    execute store result storage asset:node Amount.Fire double 0.001 run scoreboard players get $Amount.Fire Temporary
...
# Water
    ...
    execute store result storage asset:node Amount.Water double 0.001 run scoreboard players get $Amount.Water Temporary
...
# Wind
    ...
    execute store result storage asset:node Amount.Wind double 0.001 run scoreboard players get $Amount.Wind Temporary
...
# Earth
    ...
    execute store result storage asset:node Amount.Earth double 0.001 run scoreboard players get $Amount.Earth Temporary
...
# Light
    ...
    execute store result storage asset:node Amount.Light double 0.001 run scoreboard players get $Amount.Light Temporary
...
# Dark
    ...
    execute store result storage asset:node Amount.Dark double 0.001 run scoreboard players get $Amount.Dark Temporary
