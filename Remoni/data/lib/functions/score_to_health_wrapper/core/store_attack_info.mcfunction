...
# 攻撃者名を記録する
    ...
    execute at @s as @e[type=!player,distance=..150] if score @s EntityUUID = $LatestAttacker Temporary run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].LatestAttackInfo.Name set from entity @s CustomName
# 攻撃属性をEnumとして保存する
